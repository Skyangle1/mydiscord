// Simulasi query yang digunakan dalam handler
const { db } = require('./database/db');

console.log('Simulasi query seperti dalam handler...');
...
// Gunakan metode yang persis seperti dalam handler
const stmt = db.prepare('SELECT * FROM families WHERE owner_id = ?');
...
const result2 = stmt.get(userId2);
